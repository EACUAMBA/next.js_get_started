...
const name = 'Edilson Alexandre Cuamba';
		...
		<div className={styles.container}>
			...
			<header className={styles.header}>
				{home ? (
					...
					<>
						<Link href="/"><a><Image priority src="/images/profile.jpg" className={utilStyles.borderCircle} height={108} width={108} alt={name} /></a></Link>
						<h2 className={utilStyles.headingLg}> <Link href="/"><a className={utilStyles}>{name}</a></Link></h2>
					</>
				)}
			</header>
			<main>{children}</main>
